...
namespace Manager {
    ...
    internal class AuditEventFile {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Service {0}  validation failed..
        /// </summary>
        internal static string ServiceValidationFailed {
            get {
                return ResourceManager.GetString("ServiceValidationFailed", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Service {0} successfully validation..
        /// </summary>
        internal static string ServiceValidationSuccess {
            get {
                return ResourceManager.GetString("ServiceValidationSuccess", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to User {0} authenticated failed..
        /// </summary>
